# Trains feature extraction multi SVMs on a dataset, and saves the evaluation scores in a txt
...
model_serial_number = "feat_ext_" + model_type + "_multi_" + datetime.now().strftime("%m_%d_%H_%M_%S")
